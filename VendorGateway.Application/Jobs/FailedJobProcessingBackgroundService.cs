...
{
    public class FailedJobProcessingBackgroundService(IServiceScopeFactory scopeFactory) : BackgroundService
    {
        ...
        private async Task ProcessBatchAsync(CancellationToken ct)
        {
            ...
            var jobs = await jobCommands.ClaimNextBatchAsync(BatchSize, ct, JobStatus.Failed);
